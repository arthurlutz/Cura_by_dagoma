...
class convertImageDialog(wx.Dialog):
	def __init__(self, parent, filename):
		...
		p.SetSizer(s)
		s.Add(wx.StaticText(p, -1, _('Hauteur (mm)')), pos=(0, 0), flag=wx.LEFT|wx.TOP|wx.RIGHT, border=5)
		self.heightInput = wx.TextCtrl(p, -1, '10.0')
		s.Add(self.heightInput, pos=(0, 1), flag=wx.LEFT|wx.TOP|wx.RIGHT|wx.EXPAND, border=5)

		s.Add(wx.StaticText(p, -1, _('Epaiseur de la Base (mm)')), pos=(1, 0), flag=wx.LEFT|wx.TOP|wx.RIGHT, border=5)
		...
		s.Add(wx.StaticText(p, -1, _('Largeur (mm)')), pos=(2, 0), flag=wx.LEFT|wx.TOP|wx.RIGHT, border=5)
		self.widthInput = wx.TextCtrl(p, -1, str(w * 0.3))
		s.Add(self.widthInput, pos=(2, 1), flag=wx.LEFT|wx.TOP|wx.RIGHT|wx.EXPAND, border=5)

		s.Add(wx.StaticText(p, -1, _('Profondeur (mm)')), pos=(3, 0), flag=wx.LEFT|wx.TOP|wx.RIGHT, border=5)
